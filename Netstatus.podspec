...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "khusboo.suhasini" => "khusboo.suhasini@techjini.com" }
  # Or just: spec.author    = "khusboo.suhasini"
  # spec.authors            = { "khusboo.suhasini" => "khusboo.suhasini@techjini.com" }
  # spec.social_media_url   = "https://twitter.com/khusboo.suhasini"
  ...
  # spec.source       = { :http => 'file:' + __dir__ + "/" }
   spec.source       = { :git => "https://github.com/khusboosuhasiniTJ/Netstatus.git", :tag => "#{spec.version}" }
